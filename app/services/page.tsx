...
export const metadata: Metadata = {
  ...
  description:
    "השירותים של נמר סושיאל: ניהול סושיאל, הפקת וידאו לרשתות, קמפיינים ממומנים וכתיבת ניוזלטרים - מעטפת מותג מלאה תחת גג אחד.",
  ...
  return (
    <>
      ...
      <PageHero
        kicker="Services"
        title="שירותים"
        answer="נמר סושיאל מציעה מעטפת מותג מלאה: ניהול סושיאל, הפקת וידאו לרשתות, קמפיינים ממומנים וכתיבת ניוזלטרים. כל שירות עומד בפני עצמו ומשתלב לשפה מותגית אחת."
        crumbs={crumbs}
        variant="lime"
        mascot="head"
      />
