  ...
  return (
    <>
      ...
      <PageHero
        ...
        answer="נמר סושיאל היא סוכנות סושיאל ווידאו שבונה לעסקים נוכחות דיגיטלית שנראית כמו מותג אמיתי. במקום להיות ספק חיצוני, אנחנו הופכים לשותפים — וזה מתחיל מלהכיר אתכם באמת."
        crumbs={crumbs}
        variant="dark"
        mascot="peek"
      />
