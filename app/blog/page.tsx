...
export const metadata: Metadata = {
  title: "בלוג ותובנות - סושיאל ומיתוג",
  description:
    "מדריכים ותובנות מקצועיות על ניהול סושיאל, מיתוג דיגיטלי והפקת וידאו לעסקים.",
  ...
  return (
    <>
      ...
      <PageHero
        kicker="Insights"
        title="בלוג ותובנות"
        answer="מדריכים ותובנות מקצועיות על סושיאל, מיתוג דיגיטלי ווידאו - כתובים כדי לעזור לכם לבנות נוכחות שעובדת."
        crumbs={crumbs}
      />
